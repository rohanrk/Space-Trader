...
abstract class TradeGood(val MTLP: Int, val MTLU: Int, val TTP: Int, val basePrice: Int, val IPL: Int,
                         val variance: Int, val IE: Event, val CR: ResourceLevel, val ER: ResourceLevel,
                         val MTL: Int, val MTH: Int, val GTD: Government, val GTS: Government, val name: String,
                         var amount: Int) {
