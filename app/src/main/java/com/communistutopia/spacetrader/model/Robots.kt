...
/**
 * subclass of TradeGood, used to represent a good of type Robots
 *
...
class Robots(MTLP: Int, MTLU: Int, TTP: Int, basePrice: Int, IPL: Int, variance: Int, IE: Event, CR: ResourceLevel,
               ER: ResourceLevel, MTL: Int, MTH: Int, GTD: Government, GTS: Government, amount: Int
) : TradeGood(MTLP, MTLU, TTP, basePrice, IPL, variance, IE, CR, ER, MTL, MTH, GTD, GTS, "robots", amount)